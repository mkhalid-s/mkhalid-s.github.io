...
// The hero statement sits beneath the name, with interactive terms for detail.
                ...
                <section id="open-source" aria-labelledby="open-source-heading" className="mt-10">
                  ...
                  {openSourceContributions.map((contribution) => (
                    <article
                      ...
                      className="border-t border-ink/15 py-6 last:border-b"
                    >
                      ...
                      <p className="mt-1 font-mono text-[12px] text-muted">{contribution.title}</p>
                ...
                {aiPillars.map((p, i) => (
                  <Reveal key={p.label} delay={i * 0.05}>
                    <div className="rounded-xl border border-ink/10 p-5 transition duration-300 hover:-translate-y-0.5 hover:border-accent/50 hover:shadow-sm">
                      <div className="mb-1 font-display text-lg font-normal text-ink">
                        {p.label}
                      </div>
                ...
                >
                  <Reveal delay={0.1}>
                    <h3
                      ...
                      className="mb-0 font-mono text-[11px] uppercase tracking-[0.18em] text-muted"
                    >
                      POCs & shipped work
                    </h3>
                  </Reveal>
              ...
              <Reveal>
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {certifications.map((c) => (
                    ...
                    >
                      <span aria-hidden="true" className="mt-0.5 text-[11px] text-accent">
                        ✓
                      </span>
        ...
        return (
          <li key={id} className="group/item relative pb-9 pl-6 last:pb-1">
            ...
            <Reveal y={10} delay={i * 0.05}>
              ...
              {roleLoc && <div className="mt-0.5 font-mono text-[12px] text-muted">{roleLoc}</div>}
