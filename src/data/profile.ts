...
export const nodes: GraphNode[] = [
  // ── Experience ────────────────────────────────────────────────────────────
  {
    ...
    summary: 'Building and modernising the Guidewire Cloud Platform for global insurers.',
    detail: [
  ...
  },
  {
    ...
    keywords: 'treasury management banking finance financial system features jvm java clients',
  },
  ...
  // ── Skills ────────────────────────────────────────────────────────────────
  {
    ...
    cluster: 'jvm',
    weight: 1.3,
    summary: 'Primary language for a decade — enterprise scale.',
    tags: ['java', 'jvm'],
    keywords: 'java jvm enterprise backend',
  },
  {
    id: 'sk-spring',
    label: 'Spring Boot',
    ...
    cluster: 'jvm',
    weight: 1.1,
    summary: 'Services, REST, reactive, integration.',
    tags: ['spring-boot', 'java'],
    keywords: 'spring boot reactive rest microservices java',
  },
  {
    id: 'sk-aws',
    label: 'AWS',
    ...
    cluster: 'jvm',
    weight: 1.0,
    summary: 'Cloud infra, serverless, deployment.',
    tags: ['aws', 'cloud'],
    keywords: 'aws cloud lambda serverless infrastructure deployment',
  },
  {
    id: 'sk-react',
    label: 'React / TS',
    ...
    cluster: 'web',
    weight: 1.0,
    summary: 'Modern typed front-ends (this site included).',
    tags: ['react', 'typescript', 'web'],
    keywords: 'react typescript frontend ui spa vite',
  },
  {
    id: 'sk-angular',
    label: 'Angular',
    ...
    cluster: 'web',
    weight: 0.8,
    summary: 'Enterprise SPAs at eGain.',
    tags: ['angular', 'web'],
    keywords: 'angular spa frontend typescript',
  },
  {
    id: 'sk-llm',
    label: 'LLM / MCP',
    ...
    cluster: 'llm',
    weight: 1.2,
    summary: 'Agents, tool use, MCP servers, token optimization.',
    tags: ['llm', 'mcp', 'ai', 'tokens'],
    keywords: 'llm mcp agents tool use token optimization context window prompt anthropic claude',
  },
  {
    id: 'sk-python',
    label: 'Python',
    ...
    cluster: 'llm',
    weight: 1.0,
    summary: 'AI/ML tooling, scripting, services.',
    tags: ['python', 'ai'],
    keywords: 'python ai ml scripting data tooling',
  },
  {
    id: 'sk-rust',
    label: 'Rust',
    ...
    cluster: 'llm',
    weight: 0.8,
    summary: 'Performance-critical components.',
    tags: ['rust', 'performance'],
    keywords: 'rust performance systems memory safety',
  },
  {
    id: 'sk-docker',
    label: 'Docker / CI-CD',
    ...
    cluster: 'jvm',
    weight: 0.9,
    summary: 'Containers and delivery pipelines.',
    tags: ['docker', 'ci-cd', 'cloud'],
    keywords: 'docker containers ci cd pipelines delivery automation',
  },
  {
    id: 'sk-postgres',
    label: 'PostgreSQL',
    ...
    cluster: 'jvm',
    weight: 0.8,
    summary: 'Relational modelling and queries.',
    tags: ['postgresql', 'sql'],
    keywords: 'postgresql sql database relational queries',
  },
  {
    id: 'sk-ffmpeg',
    label: 'FFmpeg',
    ...
    cluster: 'media',
    weight: 0.8,
    summary: 'Video/audio pipelines.',
    tags: ['ffmpeg', 'media', 'video'],
    keywords: 'ffmpeg video audio media pipeline encoding',
  },
  {
    id: 'sk-sysdesign',
    label: 'System Design',
    ...
    cluster: 'foundations',
    weight: 0.9,
    summary: 'Designing for scale and clarity.',
    tags: ['system-design', 'architecture'],
    keywords: 'system design architecture scalability distributed dsa algorithms',
  },
  ...
  // ── Ideas (the "how I think" layer) ──────────────────────────────────────
  {
    ...
    keywords:
      'do more with less efficiency minimalism signal noise compression tokens philosophy subtract simplicity',
  },
  {
    ...
    keywords:
      'cost aware ai token economics unit economics cloud spend efficiency budget llm pricing',
  },
]
